require('dotenv').config(); // Carrega o arquivo .env se ele existir

// Se houver uma URL de conexão no .env (Neon), usamos ela. Caso contrário, usa o Docker local.
if (process.env.DATABASE_URL) {
    ...
    module.exports = { // usar a syntaxe de module.exports do CommonJS pois o sequelize não indende o import export do ES6
